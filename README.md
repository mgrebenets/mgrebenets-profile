...
| Email | mgrebenets@gmail.com, i4niac@i4napps.com |


## Summary
Full 7 years working in a big IT company (Samsung Electronics). 
Taking part in all of software development stages, starting with requirements specification and ending up with testing and support. 

Solid 6+ years background with mobile development; mainly iOS, partially Android. 
A number of apps in AppStore, both my personal and developed for employers. 
Software Tests Automation experience for Mobile apps (native, web and hybrid).
...
- Programming Languages & Technologies
  - Proficient in C, C++, Objective-C/C++, Java, Ruby
...
The apps that I developed while working for different employers are
- Monkeybars (http://appstore.com/monkeybarsinc)
- IGA Mobile (http://appstore.com/igamobileforenterprise)

### Test Automation Engineer
*[News Corp Australia](http://newscorp.com/)*<br/><font color='gray'>April 2013 - Present (10 months) | Sydney, CBD</font>
...
- Designed and implemented Common Access Card solution for MFP (compliant with FIPS, NIST and DoD requirements)
...
- Enjoying various activities like table tennis, pool, foosball, volleyball, board and card games, and many more
